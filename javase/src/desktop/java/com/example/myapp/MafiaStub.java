 ...
 * @author Shai Almog
 */
public class MafiaStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Mafia";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MafiaStub());
    }
